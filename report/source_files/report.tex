...
%	\end{itemize}
	...
	% Thoughts
	% Maybe I should also log-transform SiT and PT for the training of the surrogate models, since these variables are close to zero and may be not very gaussian
	% maybe switch to ESA CCI for stationarity, since resolution is not critical
